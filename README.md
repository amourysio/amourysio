...
Motivated and hard-working academy student working towards a B.S.(Bachelor of Science) in profile Software Development. Seeking to use my superior knowledge of programming in C++, C#, Python, Java and my advanced Technology Skills to serve in an intern or junior position. Dedicated, motivated, and committed to becoming a dependable and, valuable team member.
